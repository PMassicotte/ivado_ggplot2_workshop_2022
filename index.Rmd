...
If `method` is not specified, a `loess` or a `gam` model will be used depending on the number of points.
...
As we did for the colours, the size of the geom (ex.: dots) can be based on a particular variable.
...
- Many components can be modified with the `theme()` function. 
