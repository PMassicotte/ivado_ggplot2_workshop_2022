...
<center>
    <img src="https://activewizards.com/content/blog/How_to_Choose_the_Right_Chart_Type_[Infographic]/chart-types-infographics04.png" alt="drawing" height="375"/>
    <figcaption>
...
It is also possible to make spatial map with `ggplot2`.
...
Avoid unnecessary background and heavy gridlines.
...
p2 <- p1 +
  theme_gray() +
  theme(
    panel.grid = element_line(size = 0.25, color = "black"),
...
<center>
<figure>
  <img src="img/better_data_visualization.png" width="200">
  <figcaption>
    TODO use magik for a collage?
</figcaption>
</figure>
