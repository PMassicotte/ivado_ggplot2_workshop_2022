...
- Exploratory data analysis and visualization.
  ...
  - **Make presentation of scientific results less boring**
...
©Guislain Bécu ©Marie-Hélène Forget
</center>
...
- *Organic matter & biomass of phytoplankton*
...
- I am open to working with any kind of data. 
...
- Passionate you!
  ...
  - **Finding your own dataset can be an interesting/formative experience!**
  
- Large enough to practice your **data cleaning** and **data visualization** skills.
...
<center>
<img src="https://bit.ly/3FzRG2p" alt="Ringed seal looking at you with sea ice in the background" width="700"> 
<small>
<figcaption>https://commons.wikimedia.org/wiki/File:Pusa_hispida_(Osaka_Aquarium_KAIYUKAN).JPG</figcaption>
</small>
</center>
...
```{r, fig.height=5, out.width="55%", crop = TRUE}
...
The dataset contains a total of **`r nrow(df)` observations collected between 1990 and 2015** ([Data from the Government of Canada](https://open.canada.ca/data/en/dataset/1318c39f-74ca-4f8a-b81c-95e1694553eb/resource/5556ff66-8298-4190-929b-8a06a8ce2dc9)).

- Key variables:

  - Localisations (16 communities)
  ...
  - Weight (kg)
  - Fat thickness (cm)
  - Day of the year for melting/freezing of the sea ice
...
df %>%
  ...
  kableExtra::row_spec(1:10, font_size = 18) %>% 
...
Short list of questions that could be explored with this data:

--

- Are they any changes in the ringed seal population in the Nunavut?

--

- Links with environmental variables:
...
- Fishery information (standing stock and food resources).
